...
@section('content')
    <div class="content" style="min-height: 335px;background: white">
...
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    <div class="text-center dont-have">Bạn chưa có tài khoản? <a href="{{ route('get.register') }}">Đăng ký</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
